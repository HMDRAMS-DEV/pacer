// Draws the background for Pacer's disk image window: warm paper, a faint dot grid,
...
func draw() {
    ...
    // The dot grid, like the charts in the app.
    ...
    for (index, x) in dots.enumerated() {
        ...
        color(0x0A84FF, 0.35 + 0.65 * t).setFill()
    ...
    let title = NSAttributedString(string: "Drag Pacer to Applications", attributes: [
